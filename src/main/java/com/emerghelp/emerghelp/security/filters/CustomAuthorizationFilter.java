...
import com.emerghelp.emerghelp.security.utils.SecurityUtils;
...
import static com.emerghelp.emerghelp.security.utils.SecurityUtils.JWT_PREFIX;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        boolean isRequestPathPublic = SecurityUtils.PUBLIC_ENDPOINTS.contains(requestPath);
        ...
        if(authorizationHeader != null) {
            ...
            JWTVerifier verifier = JWT.require(Algorithm.HMAC512("secrets".getBytes()))
